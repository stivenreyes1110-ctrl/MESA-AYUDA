...
function TablaGestionTi({ setAbrir, seleccionTicket, setSeleccionTicket, setOpen, respuesta, setRespuesta, logeo, getTickets, page, setPage, tickets, setTickets,    filtroTickets, setFiltroTickets,
