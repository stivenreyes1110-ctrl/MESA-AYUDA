...
function TodosGraficos({ logeo }) {
    ...
    const sumaHoras = diferencia.reduce(
    ...
    const getConteo = async () => {
        try {
            ...
            const respuesta = await fetch(
                `http://128.0.18.50:3011/api/conteo/${id}`
            );
    ...
    const getConteoTickets = async () => {
        try {
            const respuesta = await fetch(
                "http://128.0.18.50:3011/api/conteo"
            );
                        ...
                        <div>
                            ...
                            <div className="flex items-center gap-2 mt-2">
                                ...
                                <span className="text-xs text-slate-400">
                                    <p>tiempo estimado de solucion de tickets {promedio} minutos</p>
                                </span>
