...
function AsignacionGestionTickets({ abrir, setAbrir, seleccionTicket, tickets, getTickets, page, setPage,logeo }) {
    ...
    const getInge = async () => {
        try {
            const respuesta = await fetch(`http://128.0.18.50:3011/api/usuarios/soporte/${mesa}`,
        {
          method: "GET",
          headers: {
                        ...
                        <div className="bg-white border border-gray-100 shadow-sm rounded-2xl p-6">
                            ...
                            <div className="bg-blue-50 border border-blue-100 rounded-xl p-4">
                                <p className="text-sm text-blue-800">
                                    El ingeniero seleccionado recibirá automáticamente la asignación del ticket.
                                </p>
                            </div>
                        </div>
                    </div>
...
export default AsignacionGestionTickets;
