...
function ProcesoGestionTickets({ open, onClose, respuesta, setOpen, tickets, getTickets, page, setPage, logeo }) {
...
export default ProcesoGestionTickets;
